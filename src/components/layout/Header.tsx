    ...
    <header className="sticky top-0 z-50 border-b border-border bg-bg/90 backdrop-blur-md">
      <div className="mx-auto flex h-14 max-w-[1440px] items-center gap-4 px-4 lg:px-6">
        ...
        <Link href="/" className="flex items-center gap-2.5">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path
              ...
              fill="none"
            />
            <path d="M12 7l-5 3v4l5 3 5-3v-4l-5-3z" fill="#00e5a0" fillOpacity="0.2" />
          </svg>
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-lg border border-border bg-surface px-3 py-1.5 text-sm text-text-dim transition-colors hover:border-text-dim"
        >
        ...
        <nav className="hidden items-center gap-1 md:flex">
          ...
          <a
            ...
            className="rounded-md p-2 text-text-secondary transition-colors hover:text-text"
            aria-label="GitHub"
          >
