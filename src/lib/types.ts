...
export const SECTIONS: SectionInfo[] = [
  ...
  { slug: 'config', label: 'Configuration', order: 4, blurb: 'Every config section and key.' },
  {
    ...
    order: 5,
    blurb: 'Built-in profiles and how to write your own.',
  },
  {
    slug: 'api',
    label: 'API reference',
    order: 6,
    blurb: 'REST endpoints, WebSocket events, IPC routes.',
  },
  {
    slug: 'guides',
    label: 'Guides',
  ...
  },
  {
    ...
    label: 'Security',
    order: 8,
    blurb: 'Threat model, trust boundaries, advisories, disclosure.',
  },
  {
    slug: 'pro',
    label: 'Pro',
    order: 9,
    blurb: 'Team sync, license lifecycle, encrypted key management.',
  },
  {
    slug: 'enterprise',
    label: 'Enterprise',
    order: 10,
    blurb: 'SSO, RBAC, SIEM, compliance, air-gapped deployment.',
  },
  {
    slug: 'ops',
    label: 'Operations',
    order: 11,
    blurb: 'Running, logging, updating, releasing grith.',
  },
  {
    slug: 'resources',
    label: 'Resources',
    order: 12,
    blurb: 'Architecture, glossary, FAQ, changelog, roadmap.',
  },
];
