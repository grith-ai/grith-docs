...
description: '1618 credential patterns, matched against the arguments of every call in a single pass.'
section: 'filters'
order: 7
tier: 'community'
version: '0.3.1'
...
assignments. All 1618 compile into one regex set, matched in a single pass; the
...
so start from a copy of the 1618. See [Filter config files](/docs/config/filter-config-files).
