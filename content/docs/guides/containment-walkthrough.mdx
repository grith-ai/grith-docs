...
The session-containment filter contributed +4 (out of zone). The
sensitive-path-heuristic filter didn't fire, but the containment filter alone took
it past the auto-allow threshold.
